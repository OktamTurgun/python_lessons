...
with open(r"C:\\Users\\User\\Documents\\GitHub\\python_lessons\\python_lessons\\33-dars.Pickle\\Practice\\pi_million_digits.txt") as file:
    pi = file.read().strip().replace("\n", "").replace(" ", "")  # Fayldagi matnni o'qib olamiz
...
print(f"Fayldan o'qilgan π soni: {pi_from_file}") # Fayldan o'qilgan π soni: 3.141592653589793